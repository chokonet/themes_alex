<?php
	...
	switch($payment_status){
		case 'Completed':
			mail( $admin_email, "Suscripción Childfund: Operación de PayPal completada!", $req, "From: $admin_email");
		...
		$wpdb->query(
			$wpdb->prepare(
				"INSERT INTO wp_donativos ( tipo, programa, monto, txn_id, payment_status, fecha )
					VALUES ( %s, %s, %d, %s, %s, %s )",
					'suscripcion', $programa, $monto, $txn_id, $payment_status, $fecha
			)
		);
	}
