<?php get_header(); ?>
	...
	*/ ?>
	...
	<div class="botones_home">
		<a href="<?php echo site_url('nuevosproductos/'); ?>"><img src="<?php bloginfo('template_url'); ?>/images/CTA_nuevosproductos.jpg" alt="Conoce nuestros programas y como apoyarlos" /></a>
