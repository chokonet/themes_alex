...
// FRONT END SCRIPTS AND STYLES //////////////////////////////////////////////////////
	...
	add_action( 'wp_enqueue_scripts', function(){
		...
		wp_enqueue_style( 'chosen', CSSPATH.'chosen.css' );
...
// MODIFICAR EL MAIN QUERY ///////////////////////////////////////////////////////////
	...
	add_theme_support( 'post-thumbnails' );
		add_image_size('featured_slide', 395, 517, true);
		add_image_size('single_post', 655, 300, true);
		add_image_size('news_small', 224, 294, true);
