	...
	// SELECT NATIONALITY ///////////////////////////////////////////////////////////////////
		...
		$('#bt-select-nationality').on('click', function () {
			...
			if (nationality != null){
				...
				var update = update_option('escort_nationalities', nationality);
	...
	// SELECT TYPE ///////////////////////////////////////////////////////////////////
		...
		$('#bt-select-contact-type').on('click', function () {
			...
			if ( type != null){
				...
				var update = update_option('escort_venues', type);

				update.done(function (data){
					$('<option></option>',{
						'value'  : type,
						'text'   : type
					}).appendTo('select#contact-girl-type');

					$('select#contact-girl-type').selectmenu();
				});
			}
	...
	// SELECT REGION ///////////////////////////////////////////////////////////////////
		...
		$('#bt-select-contact-region').on('click', function () {
			...
			if ( region != null ){
				...
				var update = update_option('escort_regions', region);
	...
	// SELECT AREA ///////////////////////////////////////////////////////////////////
		...
		$('#bt-select-contact-area').on('click', function () {
			...
			if ( area != null ){
				...
				var update = update_option('escort_areas', area);
	...
	// SELECT ETHNICITY ///////////////////////////////////////////////////////////////////
		...
		$('#bt-select-ethnicity').on('click', function () {
			...
			if ( ethnicity != null ){
				...
				var update = update_option('escort_ethnicities', ethnicity);
...
*/
	...
	// RATE HER //////////////////////////////////////////////////////////////////////////
		...
		$('#rate-her').live('click', function () {
			$('#rate-her').fadeOut(0);
			$('.rate_her').fadeIn(0);
			$('.flag-span').css({'margin-top':'5px'});
			$('.top_mail').css({'margin-top':'23px'});
		});
