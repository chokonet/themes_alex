				...
				<?php
					...
					if (  $the_query->have_posts()  ) : while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
						<?php $img_url = wp_get_attachment_image_src('', 'imagen_girl');
							  $img_url2 = wp_get_attachment_image_src('', 'imagen_girl_large');

						$imagen = pathinfo($img_url[0]); ?>

						<div class="girl draggable" data-id_imagen="<?php the_ID(); ?>" data-url="<?php echo $img_url2[0]; ?>">
							<div class="info_container">
								<img src="<?php echo $img_url[0]; ?>" class="thumb"></a>
								<img class="elimina_imagen" src="<?php echo THEMEPATH; ?>/images/ico-no.png">
								<div class="crop_image" data-name= "<?php echo $imagen['filename']; ?>">crop</div>
							</div>
						</div><!-- end imagen -->
