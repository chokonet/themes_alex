  ...
  fjs.parentNode.insertBefore(js, fjs);
		...
		<div id="wrapper">
			...
			<header>
				...
				<div id="header" class="<?php echo $objeto->slug ?>">
					<div id="header-top">
						<div id="logo">
						...
						<div id="redes">
							<ul>
								...
								<li>
									<a href="http://facebook.com/codigoespagueti" id="facebook">Facebook</a>
								</li>
								<li>
									<a href="http://twitter.com/codigoespagueti" id="twitter">twitter</a>
								</li>
								<li>
									<a href="http://codigoespagueti.com.com/rss" id="rss">rss</a>
								</li>
							</ul>
						</div><!-- end #redes -->
						<div id="busqueda">
					...
					<nav>
						<div id="nav">
							...
							<ul>
								<li>
									<a href="<?php echo bloginfo('url'); ?>/noticias" class="<?php if ($na == 'Noticias'): echo 'select'; endif;  ?>">Noticias</a>
								</li>
								<li>
									<a href="<?php echo bloginfo('url'); ?>/tecnologia" class="<?php if ($na == 'Tecnología'): echo 'select'; endif;  ?>">Tecnología</a>
								</li>
								<li>
									<a href="<?php echo bloginfo('url'); ?>/internet" class="<?php if ($na == 'Internet'): echo 'select'; endif;  ?>">Internet</a>
								</li>
								<li>
									<a href="<?php echo bloginfo('url'); ?>/ciencia" class="<?php if ($na == 'Ciencia'): echo 'select'; endif;  ?>">Ciencia</a>
								</li>
								<li>
									<a href="<?php echo bloginfo('url'); ?>/videojuegos" class="<?php if ($na == 'Videojuegos'): echo 'select'; endif;  ?>">Videojuegos</a>
								</li>
								<li>
									<a href="<?php echo bloginfo('url'); ?>/cultura" class="<?php if ($na == 'Cultura'): echo 'select'; endif;  ?>">Cultura</a>
								</li>
								<li>
									<a href="<?php echo bloginfo('url'); ?>/opinion" class="<?php if ($na == 'Opinión'): echo 'select'; endif;  ?>">Opinión</a>
								</li>
								<li>
									<a href="<?php echo bloginfo('url'); ?>/resenas" class="<?php if (($na == 'resenas') or ($res == 'resenas')): echo 'select'; endif;  ?>">Reseñas</a>
								</li>
							</ul>
						</div><!-- end #nav -->
					</nav>
					<?php if(is_home()) { ?>
					<div id="tweet-ticker">
						<a id="pajarito" href="http://twitter.com/codigo_espagueti"><img src="<?php echo bloginfo('template_url'); ?>/images/tweet-ticker.png"></a>
						<ul id="tweets">
