...
<!--
	...
	-->
					...
					<div class="lugares-zona-single-desplegado">
										...
										<script type="text/javascript">
									    	function initialize() {
												...
												var styledMap = new google.maps.StyledMapType(styles, {name: "Styled Map"});
										      	...
										      	var myLatLong = new google.maps.LatLng(<?php echo $latlong; ?>);
										        ...
										        var map = new google.maps.Map(document.getElementById("map-canvas_<?php echo $countermapas; ?>"), mapOptions);
							   			...
							   			?>
										<div class="maparender" id="map-canvas_<?php echo $countermapas; ?>">
										</div>
									</div><!-- mapContainer -->
						...
						<?php $countermapas++; } endwhile; endif; wp_reset_query(); ?>
...
-->
					...
					<div class="loop-lugares clearfix">
						<?php
							if(have_posts()): while(have_posts()): the_post();
						...
						<div <?php post_class('lugar-home'); ?> data-post_id="post-<?php echo $post->ID; ?>" >
							<a class="link-foto" href="<?php the_permalink(); ?>">
								<?php the_post_thumbnail( 'cuadrado_grande' ); ?>
							</a>
