<?php get_header(); ?>
		...
		<div id="content">
				...
				<div class="single_izq">
					<div class="tercio">
						<h2 class="brand_gris">Branding y Etiqueta</h2>
						<?php $termino = get_term_by( 'slug', 'branding-y-etiqueta', 'category' ); ?>
		...
		<div class="single_der ana_g">
					...
					<div class="un_tercio tercio preguntale brand_gris">
						<a href="<?php echo home_url('/consulta-a-ana/'); ?>"><h2 class="brand_gris">Consulta a Ana</h2></a>
