<?php get_header(); ?>
		...
		<div id="content">
				...
				<div class="single_izq">
					<div class="tercio">
						<h2 class="brand_anara">Salud y Bienestar</h2>
						<?php $termino = get_term_by( 'slug', 'salud-y-bienestar', 'category' ); ?>
		...
		<div class="single_der">
					...
					<div class="un_tercio tercio preguntale brand_anara">
						<a href="<?php echo home_url('/consulta-a-ana/'); ?>"><h2 class="brand_anara">Consulta a Ana</h2></a>
