<?php get_header(); ?>
		...
		<div id="content">
				...
				<div class="single_izq">
					<div class="tercio">
						<h3 class="brand_anara">Tu vida en bienestar</h3>
						<?php $termino = get_term_by( 'slug', 'tu-vida-en-bienestar', 'category' ); ?>
						<p><?php echo $termino->description; ?></p>
					</div>

					<?php
					$paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
					$args = array('posts_per_page' => 4,'paged' => $paged,'post_type' => 'post','tax_query' => array(array('taxonomy' => 'category','field' => 'slug','terms' => 'tu-vida-en-bienestar' ) ));
