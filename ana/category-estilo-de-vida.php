<?php get_header(); ?>
		...
		<div id="content">
				...
				<div class="single_izq">
					<div class="tercio">
						<h2 class="brand_rojo">Estilo de Vida</h2>
						<?php $termino = get_term_by( 'slug', 'estilo-de-vida', 'category' );	?>
		...
		<div class="single_der">
					...
					<div class="un_tercio tercio preguntale brand_rojo ">
						<a href="<?php echo home_url('/consulta-a-ana/'); ?>"><h2 class="brand_rojo">Consulta a Ana</h2></a>
