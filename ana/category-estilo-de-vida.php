<?php get_header(); ?>
		...
		<div id="content">
				...
				<div class="single_izq">
					<div class="tercio">
						...
						<h3 class="brand_rojo">Estilo de Vida</h3>
					<?php
						$termino = get_term_by( 'slug', 'estilo-de-vida', 'category' );
					...
					$args = array('posts_per_page' => 4,'paged' => $paged,'post_type' => 'post','tax_query' => array(array('taxonomy' => 'category','field' => 'slug','terms' => 'estilo-de-vida' ) ));
					
					query_posts( $args );
					while ( have_posts() ) : the_post(); ?>
					<div class="cada_post">
						<h4 class="post_h_rojo">
							<a href="<?php the_permalink(); ?>?a=rojo">
								<?php the_title(); ?>
							</a>
						</h4>
						...
						<div class="cada_post_p_warp">
							...
							<div class="cada_post_leer_rojo"> <a href="<?php the_permalink(); ?>?a=rojo"> Leer más </a> </div>
						</div><!-- cada_post_p_warp -->
						<div class="separacion_rojo sepa_blog"></div>
					</div><!-- cada_post -->	

					<?php endwhile; ?>
					<ul class="dicc_pager link_rojo">
		...
		<div class="single_der">
					...
					<div class="un_tercio tercio preguntale brand_rojo">
						<a href="<?php echo home_url('/consulta-a-ana/'); ?>"><h3 class="brand_rojo">Consulta a Ana</h3></a>
