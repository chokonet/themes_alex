		...
		<div id="content">
				...
				<div class="single_izq">
					<div class="tercio">
						...
						<h3 class="brand_azul2">Branding Laboral</h3>
					<?php
						$termino = get_term_by( 'slug', 'branding-laboral', 'category' );
					...
					$args = array('posts_per_page' => 4, 'paged' => $paged,'post_type' => 'post','tax_query' => array(array('taxonomy' => 'category','field' => 'slug','terms' => 'branding-laboral' ) ));
