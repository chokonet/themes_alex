...
window.webcam = {
	...
	swf_url: webcam_swf_url, // URI to webcam.swf movie (defaults to cwd)
	shutter_url: webcam_shutter_url, // URI to shutter.mp3 sound
	api_url: webcam_api_url, // URL to upload script
